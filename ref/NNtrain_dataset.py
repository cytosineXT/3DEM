...
from net.jxtnet_padding_recon import MeshAutoencoder
...
rcsdir = r'/mnt/Disk/jiangxiaotian/datasets/RCS_mapsmall' #T7920 
# pretrainweight = r'D:\workspace\jxtnet\output\last0420.pt' #T640
pretrainweight = r'/home/ljm/workspace/jxt/jxtnet/output/last0418.pt' #T7920
loadobj = r'./datasets/b82731071bd39b66e4c15ad8a2edd2e.obj'
loadpt = r'./datasets/b979_edges.pt'
in_ems = []
rcss = []
batchsize = 1
epoch = 100
...
for i in range(epoch):
    ...
    # torch.save(autoencoder.state_dict(), r"D:\workspace\jxtnet\output\last0420.pt") #T640
        torch.save(autoencoder.state_dict(), f"/home/ljm/workspace/jxt/jxtnet/output/epoch{i+1}0429.pt") #T7920
    torch.save(autoencoder.state_dict(), r"/home/ljm/workspace/jxt/jxtnet/output/last0429.pt") #T7920
