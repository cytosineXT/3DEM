...
# from net.jxtnet_upConv import MeshAutoencoder
...
pretrainweight = r'/home/ljm/workspace/jxt/jxtnet/output/0501upconvde_b827c9_01521good.pt' #T7920
loadobj = r'./datasets/b82731071bd39b66e4c15ad8a2edd2e.obj'
loadpt = r'./datasets/b827_edges.pt'
lastsavedir = r"/home/ljm/workspace/jxt/jxtnet/output/test/0501upconvdefast3_b8271w4_last.pt"
in_ems = []
rcss = []
batchsize = 2
epoch = 4
...
for i in range(epoch):
    ...
    # torch.save(autoencoder.state_dict(), r"D:\workspace\jxtnet\output\last0420.pt") #T640
        torch.save(autoencoder.state_dict(), f"/home/ljm/workspace/jxt/jxtnet/output/test/0502upconvdefast2_b8271w4_epoch{i}.pt") #T7920
