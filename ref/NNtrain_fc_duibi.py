...
for i in range(epoch):
    ...
    # torch.save(autoencoder.state_dict(), r"D:\workspace\jxtnet\output\last0420.pt") #T640
        torch.save(autoencoder.state_dict(), f"/home/ljm/workspace/jxt/jxtnet/output/test/0501fc_b827ceshi9_epoch{i}.pt") #T7920
    torch.save(autoencoder.state_dict(), r"/home/ljm/workspace/jxt/jxtnet/output/test/0501fc_b827ceshi9_last.pt") #T7920
