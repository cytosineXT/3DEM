...
# rcsdir = r'/mnt/Disk/jiangxiaotian/puredataset
# s/b827_xiezhen_val' #T7920 
...
save_dir = str(increment_path(Path(ROOT / "output" / "train" /'0522upconv3kan_b827_MieOpt'), exist_ok=False))##日期-NN结构-飞机-训练数据-改动
